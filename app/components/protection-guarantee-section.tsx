    ...
    <section className="py-16 md:py-24 bg-[#1C180D] relative overflow-hidden flex items-center">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center text-center">
          <h2 className="text-2xl md:text-4xl mb-8 md:mb-10">
          ...
          <div className="grid grid-cols-2 gap-x-16 gap-y-16 max-w-3xl mx-auto">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-white/80 max-w-[200px]">We work hard to keep your data safe and secure.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="mb-6">
                <img
              ...
              <p className="text-sm text-white/80 max-w-[200px]">We protect your account from unauthorized activity.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="mb-6">
                <img
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-white/80 max-w-[200px]">We've got your back. We're available to you 24/7.</p>
            </div>
          </div>
        </div>
      </div>
